...
#crear una funcion que se encargue de recibir un diccionario de las 
#notas de los estudiantes de analisis de datos que van a reprobar y obtener su min,
#max, media y desviacion estandar
